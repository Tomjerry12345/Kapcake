...
import com.kapcake.pos.Adapter.ListBluetooth;
import com.kapcake.pos.Featured.ItemClickSupport;
import com.kapcake.pos.Featured.PrinterCommands;
import com.kapcake.pos.Featured.Utils;
...
public class GetKoneksi extends AppCompatActivity {
    ...
    private void tampilanHeaderAtas(ModelPesanan listData) {
        ...
        printCustom("\n", 1, 1);
        printCustom("No Antrian : " + listData.getNoPemesanan(), 1, 1);
        printCustom("\n", 1, 1);
        printCustom(garis(), 1, 1);
    }
    ...
    private void tampilanInformasiPesanan(ModelPesanan listPesanan) {
        ...
        printCustom("No. Pesanan" + getDataSpace("No. Pesanan".length()
                , listPesanan.getNoPemesanan().length(), sizeKertas) + listPesanan.getNoPemesanan(), 1, 0);
    ...
    private void setAdapter() {
        ...
        LinearLayoutManager localLinearLayoutManager = new LinearLayoutManager(GetKoneksi.this, RecyclerView.VERTICAL, false);
